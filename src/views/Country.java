...
public class Country extends javax.swing.JInternalFrame {
    ...
    private void tbl_countriesMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_countriesMousePressed
        ...
        String b = (String) tbl_countries.getValueAt(row, 2);
        cmbRegion.setSelectedItem(regionController.selectByName(b).getId() + " - " + b);
        tid.setEnabled(false);
        
//        int y = cmbRegion.getItemCount();          //sudah dapat jumlah item combobox
//        for (int i = 0; i < y; i++) {              //looping index di combobox
//            String inde = cmbRegion.getItemAt(i);  //dapat semua data item di combobox
//            String[] splitIndex = inde.split(" - ");
//            String konversi = splitIndex[1].toString();
//            if (b.equals(konversi)) {
...
//        }
    ...
    private void bt_add1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_add1ActionPerformed
        ...
        String region_id = cmbRegion.getSelectedItem().toString();
        //ini contoh split jadi ambil kata yang di pisahkan oleh space karna di combobox nya di pisahin sama space
        //int[] jumlah = id.split(Integer.parseInt(id), 2);
        if (id.equals("")) {
            JOptionPane.showMessageDialog(null, "ID required");
        } else if (name.equals("")) {
            JOptionPane.showMessageDialog(null, "Name required");
        } else if (cmbRegion.getSelectedIndex() == 0) {
            JOptionPane.showMessageDialog(null, "Region required");
        } else {
            String[] splitRegion_id = region_id.split(" - ");
            String a = countryController.selectById(id).getId();
            if (id.equals(a)) {
                JOptionPane.showMessageDialog(this, countryController.update(name, splitRegion_id[0], id));
            } else {
                JOptionPane.showMessageDialog(this, countryController.create(name, splitRegion_id[0], id));
            }
            reset();
            bindingTabel();
        }
